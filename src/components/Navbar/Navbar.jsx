...
function Navbar() {
    ...
    const downloadHandle = () => {
        ...
        link.download = "Sachin Kumar Singh Resume.pdf";
        link.href = resume;
        link.click();
        window.open(
            "https://drive.google.com/file/d/1zaoJksCXELs7yvZ2n7-e7MEICpHFCjwp/view?usp=sharing",
            "_blank"
        );
    };
            ...
            <div id='nav-menu'>
                ...
                <div id="largeScreenNavbar">
                    ...
                    <div>
                        ...
                        <a href="https://github.com/sachin2398" target="_blank" className="nav-link github">
                            GitHub
                        </a>
                    </div>
                </div>
