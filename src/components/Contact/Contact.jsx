...
function Contact() {
    ...
    return (
        <div id='contact'>
            <h1>Contact Me</h1>
            <div>
                <div id="contact-github" className='contactCard' onClick={() => { sendto("https://github.com/sachin2398") }}>
                    <img src={Github} alt="" />
                    <h5>Github</h5>
                    <p>sachin2398</p>
                </div>
                <div id="contact-linkedin" className='contactCard' onClick={() => { sendto("https://www.linkedin.com/in/sachin-2398-dev/") }}>
